...
public class ProposalForm extends BaseTest{
	...
	public void ClickAddNew(String productName, String proposalNo,String advisorCode,String accountNum, String custRelationship) throws IOException, Throwable {
		...
		cust=new CustomerPersonalDetails(driver);
...
/*				String repoNames=option.getText();
		...
		//drop.getDeSelectByVisibleText(cust.getProposerRelationship(), custRelationship);
